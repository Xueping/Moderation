# import sys
# sys.path.append('/home/xpeng/research/projects/medicalAI_torch/src/Moderation')
import traceback
...
def test(text):
    ...
    print('{0:40}{1:8}{2:8}'.format(*fixed))


if __name__ == '__main__':
    parts = ['text','spam', 'troll']
    print('{0:40}{1:8}{2:8}'.format(*parts))
